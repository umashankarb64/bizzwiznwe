...
import { Atom, KeyRound, Eye, EyeOff, ArrowLeft, User } from 'lucide-react';
    ...
    try {
      ...
      if (response.success) {
        toast({
          ...
          description: "Votre mot de passe a été mis à jour avec succès. Redirection vers la connexion...",
          variant: 'default',
        });
        setTimeout(() => {
          setIsLoading(false);
