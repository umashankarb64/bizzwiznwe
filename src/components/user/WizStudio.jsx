    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        <div className="mb-8 sm:mb-16">
          <div className="w-16 sm:w-24 h-16 sm:h-24 bg-gradient-to-br from-purple-500 to-pink-500 rounded-3xl flex items-center justify-center mx-auto mb-6 sm:mb-8 shadow-2xl shadow-purple-500/20">
            <Palette className="w-8 sm:w-12 h-8 sm:h-12 text-white" />
          </div>
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-light text-white mb-4 sm:mb-6 tracking-wide">WIZ STUDIO</h1>
          <p className="text-white/60 font-light text-base sm:text-xl mb-4 sm:mb-8">Studio de création visuelle avancé</p>
          ...
          >
            ...
            <div className="relative bg-[#000011] rounded-2xl p-6 sm:p-8 group-hover:shadow-2xl group-hover:shadow-purple-500/10 transition-all duration-500">
              <div className="w-12 sm:w-16 h-12 sm:h-16 bg-purple-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <Palette className="w-6 sm:w-8 h-6 sm:h-8 text-purple-400" />
              </div>
              <h3 className="text-lg sm:text-xl font-light text-white mb-2 sm:mb-4">Design System</h3>
              <p className="text-white/60 font-light text-xs sm:text-sm">Créez des systèmes de design cohérents et évolutifs avec l'IA</p>
            </div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            ...
            <div className="relative bg-[#000011] rounded-2xl p-6 sm:p-8 group-hover:shadow-2xl group-hover:shadow-cyan-500/10 transition-all duration-500">
              <div className="w-12 sm:w-16 h-12 sm:h-16 bg-cyan-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <Code className="w-6 sm:w-8 h-6 sm:h-8 text-cyan-400" />
              </div>
              <h3 className="text-lg sm:text-xl font-light text-white mb-2 sm:mb-4">Code Generation</h3>
              <p className="text-white/60 font-light text-xs sm:text-sm">Générez du code optimisé directement depuis vos designs</p>
            </div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          >
            ...
            <div className="relative bg-[#000011] rounded-2xl p-6 sm:p-8 group-hover:shadow-2xl group-hover:shadow-pink-500/10 transition-all duration-500">
              <div className="w-12 sm:w-16 h-12 sm:h-16 bg-pink-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
                <Users className="w-6 sm:w-8 h-6 sm:h-8 text-pink-400" />
              </div>
              <h3 className="text-lg sm:text-xl font-light text-white mb-2 sm:mb-4">Collaboration</h3>
              <p className="text-white/60 font-light text-xs sm:text-sm">Collaborez en temps réel avec votre équipe de design</p>
            </div>
          </motion.div>
        </div>
        <button className="relative group/btn">
          ...
          <div className="relative px-8 sm:px-12 py-3 sm:py-4 bg-gradient-to-r from-purple-600/20 to-pink-500/20 rounded-2xl text-white font-light hover:shadow-lg hover:shadow-purple-500/20 transition-all duration-300 flex items-center space-x-2 sm:space-x-3">
